...
#define EC_DATAGRAM_HEADERSIZE     10U
...
enum
{
   ECT_REG_TYPE = 0x0000,  //从站 ESC 类型寄存器
   ECT_REG_PORTDES = 0x0007,
   ECT_REG_ESCSUP = 0x0008,
   ECT_REG_STADR = 0x0010,
   ECT_REG_ALIAS = 0x0012,
   ECT_REG_DLCTL = 0x0100,
   ECT_REG_DLPORT = 0x0101,  //从站端口环路控制寄存器
   ECT_REG_DLALIAS = 0x0103,  //从站别名地址启用控制寄存器
   ECT_REG_DLSTAT = 0x0110,
   ECT_REG_ALCTL = 0x0120,  //从站应用层状态控制寄存器
   ECT_REG_ALSTAT = 0x0130,  //从站应用层状态寄存器
   ECT_REG_ALSTATCODE = 0x0134,
   ECT_REG_PDICTL = 0x0140,
   ECT_REG_IRQMASK = 0x0200,  //从站 EtherCAT 事件中断屏蔽寄存器
   ECT_REG_RXERR = 0x0300,  //从站接收错误计数器起始寄存器
   ...
   ECT_REG_DCSYSTIME = 0x0910,  //从站 DC 系统时间寄存器
   ECT_REG_DCSOF = 0x0918,
   ECT_REG_DCSYSOFFSET = 0x0920,
   ECT_REG_DCSYSDELAY = 0x0928,
   ECT_REG_DCSYSDIFF = 0x092C,
   ECT_REG_DCSPEEDCNT = 0x0930,  //从站 DC 速度计数器起始寄存器
   ECT_REG_DCTIMEFILT = 0x0934,  //从站 DC 时间差滤波配置寄存器
   ECT_REG_DCCUC = 0x0980,
   ECT_REG_DCSYNCACT = 0x0981,  //从站 DC 同步激活寄存器
